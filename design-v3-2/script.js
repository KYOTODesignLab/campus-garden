(() => {
  ...
  const validRoutes = new Set(["home", "map", "3d", "maintenance", "archive", "about"]);

  function renderRoute() {
    let route = (location.hash.slice(1) || "home").toLowerCase();
    ...
    if (route === "home") requestAnimationFrame(drawCloudNow);
  }
